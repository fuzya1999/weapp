...
Page({
  ...
  details:function(e){
    console.log(e.currentTarget.dataset.detailprduct.volume)
    ...
    wx.navigateTo({
      url: "../adminprogramdetail/adminprogramdetail?productname"+"="+productname+"&toadmin"+"="+toadmin+"&salesvolume"+"="+salesvolume
    })
  }
});